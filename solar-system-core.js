...
(function (root, factory) {
  ...
  'The core of the Sun reaches temperatures of around 15 million°C.',
  'The Sun rotates faster at its equator than near its poles.',
  'Solar flares can release enormous amounts of energy.',
  'The solar wind carries charged particles away from the Sun.',
  'Sunspots are cooler regions on the surface of the Sun.',
  'The Sun contains more than 99% of the solar system mass.',
  ...
  "Earth's magnetic field helps protect the planet from solar radiation.",
  'Earth is approximately 4.54 billion years old.',
  'Earth has one natural satellite, the Moon.',
  'Earths continents move because of plate tectonics.',
  'Earth is slightly flattened at its poles.',
  'The Moon is approximately 384,400 kilometers from Earth on average.',
  'The Moon is tidally locked to Earth.',
  'The same side of the Moon generally faces Earth.',
  'The Moon has no substantial atmosphere like Earth.',
  'The Moon causes most of the regular ocean tides on Earth.',
  'The Moon is slowly moving away from Earth.',
  'Astronauts have walked on the Moon during NASA Apollo missions.',
  'The Moon has mountains, valleys, and thousands of impact craters.',
  'The Moon completes an orbit around Earth in about 27.3 days.',
  'Mars has two small moons called Phobos and Deimos.',
  'Mars appears red because of iron oxides on its surface.',
  'Mars has a canyon system called Valles Marineris.',
  'Mars once had rivers and lakes on its surface.',
  'A day on Mars is called a sol.',
  'One Martian sol lasts about 24 hours and 39 minutes.',
  'Mars has a thin atmosphere dominated by carbon dioxide.',
  'Mars has polar ice caps containing water ice and carbon dioxide ice.',
  'Mars experiences dust storms that can cover large parts of the planet.',
  'Robotic spacecraft have explored Mars for decades.',
  'Jupiter is the largest planet in the solar system.',
  'Jupiter rotates once in approximately 10 hours.',
  'Jupiter is a gas giant composed mainly of hydrogen and helium.',
  'Jupiter has a powerful magnetic field.',
  'The Great Red Spot is a massive storm in Jupiters atmosphere.',
  'The Great Red Spot has existed for centuries.',
  'Jupiter has faint rings that are difficult to see from Earth.',
  'Europa, one of Jupiters moons, has a subsurface ocean.',
  'Io is the most volcanically active world known.',
  'Ganymede is the largest moon in the solar system.',
  'Saturn is the second-largest planet in the solar system.',
  'Saturn is less dense than water.',
  'Saturn has an extensive and spectacular ring system.',
  'Saturns rings contain countless particles of ice and rock.',
  'Titan is Saturns largest moon.',
  'Titan has a thick atmosphere rich in nitrogen.',
  'Titan has lakes and seas of liquid methane and ethane.',
  'Enceladus releases water-rich plumes into space.',
  'Saturn has dozens of confirmed moons.',
  'Uranus rotates on its side compared with most other planets.',
  'Uranus has a blue-green color partly caused by methane.',
  'Uranus has a faint ring system.',
  'Uranus has 27 known moons.',
  'Uranus was discovered using a telescope in 1781.',
  'Uranus experiences extreme seasonal changes.',
  'Uranus is classified as an ice giant.',
  'Uranus is approximately four times wider than Earth.',
  'Uranus has extremely cold upper atmospheric temperatures.',
  'Neptune is the most distant major planet from the Sun.',
  'Neptune is classified as an ice giant.',
  'Neptune takes approximately 165 Earth years to orbit the Sun.',
  ...
  'Neptune receives much less sunlight than Earth.',
  'Pluto is located in the Kuiper Belt beyond Neptune.',
  'Pluto was reclassified as a dwarf planet in 2006.',
  'Pluto has five known moons.',
  'Charon is Plutos largest moon.',
  'Pluto and Charon orbit a common center of mass.',
  'New Horizons was the first spacecraft to fly past Pluto.',
  'Pluto has a large heart-shaped region called Tombaugh Regio.',
  'Plutos surface contains nitrogen, methane, and carbon monoxide ices.',
  'Pluto takes approximately 248 Earth years to orbit the Sun.',
  'Pluto can have a very thin atmosphere when it is closer to the Sun.',
  'The Milky Way is a barred spiral galaxy.',
  'The Milky Way contains hundreds of billions of stars.',
  'Our solar system is located in the Milky Ways Orion Arm region.',
